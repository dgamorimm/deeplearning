...
## removemos o input_dim, pois só colocamos na primeira camada oculta
### Camada Oculta 2
classificador.add(
    Dense(
        units=16,
...
## learning_rate : taxa de aprendizagem: lr. Tem correlação com a descida do gradiente, o quanto ele vai aprendendo e descendo
## decay :  quanto um learning rate vai ser decrementado a cada atualização de pesos
## clipvalue: ele vai fazer um clipped, ou seja, ele vai prender um valor. Se chegar em valores de pesos maiores ou menores que o determinado ele vai congelar
## esses são os parâmtros mais importantes
